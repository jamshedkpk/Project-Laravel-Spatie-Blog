...
if($save)
{
    return redirect()->route('admin-post-index')->with(['record-saved'=>'Record is successfully Stored !']);
}
}
// show a post
...
if($update)
{
    ...
    return redirect()->route('admin-post-index')->with(['record-updated'=>'Record is successfully Updated !']);    
}
}
else
{
...
File::delete($path);
    ...
    $delete=$post->delete();
if($delete){
    return redirect()->route('admin-post-index')->with(['record-deleted'=>'Record is successfully Deleted !']);
}
}
}
